...
class ResolverVisitor extends ScopedVisitor /*DEP30[*/ with ResolverVisitorNullityMixin /*]*/{
  ...
  ResolverVisitor(LibraryElement definingLibrary, Source source,
      ...
      : super/*[*/.DEP30/*]*/(definingLibrary, source, typeProvider, errorListener,
          /*DEP30, was[nameScope:]*/ nameScope) {
...
abstract class ScopedVisitor extends UnifyingAstVisitor<Object> {
  ...
  ScopedVisitor.DEP30(LibraryElement definingLibrary, source, typeProvider, AnalysisErrorListener errorListener,
                Scope nameScope) : this(definingLibrary, source, typeProvider, errorListener, nameScope:nameScope);
